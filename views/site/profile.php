...
<div class="main-wrapper">
    <div class="profile-banner-large bg-img" data-bg="/<?=$info['image']?>">
    </div>
            ...
            <div class="col-lg-3 order-2 order-lg-1">
                <aside class="widget-area profile-sidebar">
                    ...
                    <div class="card widget-item">
                        <h4 class="widget-title"><?=$user->fullName?></h4>
                        <div class="widget-body">
                            <div class="about-author">
                                <p><?=$info['add_info']?></p>
                                <ul class="author-into-list">
                                    <li><a href="#"><i class="bi bi-office-bag"></i><?=$info['profession']?></a></li>
                                    <li><a href="#"><i class="bi bi-home"></i><?=$info['country']?></a></li>
                                    <li><a href="#"><i class="bi bi-location-pointer"></i><?=$info['birthplace']?></a></li>
                                    <li><a href="#"><i class="bi bi-heart-beat"></i><?=$info['hobby']?></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="sweet-galley img-gallery">
                                <div class="row row-5">
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-1.jpg">
                                                    <img src="/dist/images/gallery/gallery-1.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-2.jpg">
                                                    <img src="/dist/images/gallery/gallery-2.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-3.jpg">
                                                    <img src="/dist/images/gallery/gallery-3.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-4.jpg">
                                                    <img src="/dist/images/gallery/gallery-4.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-5.jpg">
                                                    <img src="/dist/images/gallery/gallery-5.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-6.jpg">
                                                    <img src="/dist/images/gallery/gallery-6.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-7.jpg">
                                                    <img src="/dist/images/gallery/gallery-7.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-8.jpg">
                                                    <img src="/dist/images/gallery/gallery-8.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="gallery-tem">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector" href="dist/images/gallery/gallery-9.jpg">
                                                    <img src="/dist/images/gallery/gallery-9.jpg" alt="sweet memory">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                    ...
                    <div class="post-content">
                        ...
                        <div class="post-thumb-gallery">
                            <figure class="post-thumb img-popup">
                                <a href="dist/images/post/post-large-1.jpg">
                                    <img src="/dist/images/post/post-1.jpg" alt="post image">
                                </a>
                            </figure>
                        </div>
                        <div class="post-meta">
                            ...
                            <ul class="like-page-list-wrapper">
                                ...
                                <li class="unorder-list">
                                    ...
                                    <div class="profile-thumb">
                                        <a href="#">
                                            <figure class="profile-thumb-small">
                                                <img src="/dist/images/profile/profile-small-14.jpg" alt="profile picture">
                                            </figure>
                                        </a>
                                    </div>
                                    <!-- profile picture end -->
