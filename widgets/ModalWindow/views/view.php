...
// Links
$widget_update = Url::to([$crud_name.'/update']);
$widget_delete = Url::to([$crud_name.'/delete']);
$widget_create = Url::to([$crud_name.'/create']);
$widget_view = Url::to([$crud_name.'/view']);
$widget_copy   = Url::to([$crud_name.'/copy']);
...
<?php
/*$this->registerJsFile(
    Yii::$app->request->baseUrl.'/js/widget_ModalWindow/pnotify.js',
    [
        'depends' => [\yii\web\JqueryAsset::className()]
    ]
);*/
$this->registerJsFile(
    Yii::$app->request->baseUrl.'/dist/js/widget_ModalWindow/modal-window-widget.js',
    [
        'depends' => [\yii\web\JqueryAsset::className()]
    ]
);
